...
function sfabt_add_settings_fields() {
	...
	// Kill Heartbeat FFS!
	$label = version_compare( $GLOBALS['wp_version'], '3.6', '>=' ) ? __( 'Disable posts autosave, post lock, authentication check, and everything related to Heartbeat (for you only).', 'sf-adminbar-tools' ) : __( 'Stop posts autosave (for you only).', 'sf-adminbar-tools' ) ;
	$args  = array(
