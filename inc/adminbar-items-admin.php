		...
		if ( $typenow === 'page' ) {
			...
			if ( $pagenow === 'post-new.php' ) {
				$wp_admin_bar->add_node( array(
					...
					'title'  => sfabt_get_action_num( 'load-page-new.php' ),
					'meta'   => $meta_before,
				) );
			}
			elseif ( $pagenow === 'post.php' ) {
				$wp_admin_bar->add_node( array(
					'parent' => 'sfabt-load-hook',
					'id'     => 'sfabt-load-hook-pagenow-old',
					'title'  => sfabt_get_action_num( 'load-page.php' ),
					'meta'   => $meta_before,
				) );
			}
		...
		elseif ( $pagenow === 'edit-tags.php' ) {
			...
			if ( $taxnow === 'category' ) {
				$wp_admin_bar->add_node( array(
					'parent' => 'sfabt-load-hook',
					'id'     => 'sfabt-load-hook-pagenow-old',
					'title'  => sfabt_get_action_num( 'load-categories.php' ),
					'meta'   => $meta_before,
				) );
			}
			elseif ( $taxnow === 'link_category' ) {
				$wp_admin_bar->add_node( array(
					'parent' => 'sfabt-load-hook',
					'id'     => 'sfabt-load-hook-pagenow-old',
					'title'  => sfabt_get_action_num( 'load-edit-link-categories.php' ),
					'meta'   => $meta_before,
				) );
			}
